...
| **B-206** | **Loki-backed `get_logs`** | Time-bounded, label-filtered, cross-device, and it works when the device is unreachable — which is when the timeline matters most | T-004 finding · **blocked by B-206a and B-206b** | M | D8 |
