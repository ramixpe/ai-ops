...
| T-013 | `route` parser | DONE | sonnet-5 (opus-5 spec + review) | _next commit_ | OBS-042 | 44 fixtures; a third output shape found that the spec missed. 719 passed |
