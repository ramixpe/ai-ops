...
| T-029c | vacuous-with-claims | DONE | opus-5 | 3f82da1 | OBS-083 | Closes B-429. A warning nobody reads is not running. Audited every reader-facing flag; changed exactly one. 6 tests, 1377 passed |
| T-034 |
