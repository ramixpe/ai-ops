...
| [docs/diagrams/](docs/diagrams/) | **Thirteen hand-authored diagrams**, one unified layer — 2026-08-23 retired the old two-layer split (a generated, byte-pinned SVG set plus a separate hand-authored presentation set); that duplication and the CI byte-pin are both gone. Built with the `diagram-design` skill, describing the system end to end **as of 2026-08-24**. **These are hand-authored, not generated — they can drift from the code and are only as current as their last update.** Start at [`docs/diagrams/index.html`](docs/diagrams/index.html) |
